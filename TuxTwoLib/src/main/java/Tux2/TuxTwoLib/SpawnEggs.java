...
public class SpawnEggs {
	...
	public static ItemStack getSpawnEgg(EntityType type, int amount) {
		net.minecraft.server.v1_10_R1.ItemStack stack = CraftItemStack.asNMSCopy(new ItemStack(Material.MONSTER_EGG, amount));
		String name = "";
		switch (type) {
		case ARMOR_STAND:
			name = "ArmorStand";
	...
	public static EntityType getSpawnEggType(ItemStack is) {
		...
		net.minecraft.server.v1_10_R1.ItemStack mcis = Attributes.getMinecraftItemStack(is);
		if(mcis == null) {
			return null;
		}
